...
trait VoltDB {
   ...
   */
  def callProcedureAndMapResultSync[T](resultIndex: Int, procedureName: String, params: Any*)(f: VoltTableRow ⇒ T): Vector[T] = {
   ...
   */
  def callProcedureAndMapResult[T](resultIndex: Int, procedureName: String, params: Any*)(f: VoltTableRow ⇒ T): Future[Vector[T]] =
